      ...
      <footer className="text-white body-font bg-gray-700">
        ...
        <div className="bg-gray-800">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-white-500 text-sm text-center sm:text-left">© 2024 Style With Sutra —
              <a rel="noopener noreferrer" className="text-white-500 ml-1">@stylewithsutra</a>
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <a className="text-white-500" href='https://www.facebook.com/stylewithsutra' target="_blank">
              ...
              <a className="ml-3 text-white-500" href='https://www.instagram.com/stylewithsutra/' target='_blank'>
