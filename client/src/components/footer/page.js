      ...
      <footer className="text-white body-font bg-gray-700">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10 ">
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
              ...
              ></Image>
              <span className="ml-1 text-xl">Style With <span className='text-orange-500'>Sutra</span></span>
            </a>
        ...
        <div className="bg-gray-800">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-white-500 text-sm text-center sm:text-left">© 2024 Style With <span className='text-orange-500'>Sutra</span> —
              <a rel="noopener noreferrer" className="text-white-500 ml-1">@stylewithsutra</a>
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <a className="text-orange-500" href='https://www.facebook.com/stylewithsutra' target="_blank">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5 hover:text-white" viewBox="0 0 24 24">
              ...
              <a className="ml-3 text-orange-500" href='https://www.instagram.com/stylewithsutra/' target='_blank'>
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5 hover:text-white" viewBox="0 0 24 24">
                  <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                  <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                </svg>
              </a>
              <a className="ml-3 text-orange-500">
                <svg fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" className="w-5 h-5 hover:text-white" viewBox="0 0 24 24">
